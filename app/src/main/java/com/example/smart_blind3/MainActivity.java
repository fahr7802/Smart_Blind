...
public class MainActivity extends AppCompatActivity {
    ImageButton setting, moreaction, arrowup, arrowdown;
    int power;
...
//                Toast.makeText(getApplicationContext(), "Connect시도", Toast.LENGTH_SHORT).show();
        ...
        moreaction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), value.class);
                startActivity(intent);
            }
        });
    }
...
//                Toast.makeText(getApplicationContext(), "스마트 블라인드 작동", Toast.LENGTH_SHORT).show();
